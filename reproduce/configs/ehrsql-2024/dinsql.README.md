...
| Field | Value |
|---|---|
| Config | `reproduce/configs/ehrsql-2024/dinsql.json` |
| Dataset | `ehrsql-2024` |
| Method | `dinsql` |
| Run identifier | `ehrsql-2024-dinsql` |
...
```bash
python reproduce/run.py ehrsql-2024 dinsql
```
...
| --- | --- | --- | --- | --- |
| dinsql_generate | GenerateTask | generate_type=DINSQLGenerator | execute_accuracy | `../files/datasets/ehrsql_2024_dinsql_dinsql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| dinsql_generate | stage | `../files/datasets/ehrsql_2024_dinsql_dinsql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/ehrsql-2024/dinsql.json
```
