...
| Field | Value |
|---|---|
| Config | `reproduce/configs/ehrsql-2024/e-sql.json` |
| Dataset | `ehrsql-2024` |
| Method | `e-sql` |
| Run identifier | `ehrsql-2024-e-sql` |
...
```bash
python reproduce/run.py ehrsql-2024 e-sql
```
...
| --- | --- | --- | --- | --- |
| esql_generate | GenerateTask | generate_type=ESQLGenerator | execute_accuracy | `../files/datasets/ehrsql_2024_e_sql_esql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| esql_generate | stage | `../files/datasets/ehrsql_2024_e_sql_esql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/ehrsql-2024/e-sql.json
```
