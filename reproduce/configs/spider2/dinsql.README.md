...
| Field | Value |
|---|---|
| Config | `reproduce/configs/spider2/dinsql.json` |
| Dataset | `spider2` |
| Method | `dinsql` |
| Run identifier | `spider2-dinsql` |
...
```bash
python reproduce/run.py spider2 dinsql
```
...
| --- | --- | --- | --- | --- |
| dinsql_generate | GenerateTask | generate_type=DINSQLGenerator | execute_accuracy | `../files/datasets/spider2_dinsql_dinsql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| dinsql_generate | stage | `../files/datasets/spider2_dinsql_dinsql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/spider2/dinsql.json
```
