...
| --- | --- | --- | --- | --- |
| resdsql_parse | ParseTask | output_format=dict, parse_type=RESDSQLParser | parse_recall, parse_precision, parse_exact_matching | `../files/datasets/spider_resdsql_parse.json` |
