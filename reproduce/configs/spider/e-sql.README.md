...
| Field | Value |
|---|---|
| Config | `reproduce/configs/spider/e-sql.json` |
| Dataset | `spider` |
| Method | `e-sql` |
| Run identifier | `spider-e-sql` |
...
```bash
python reproduce/run.py spider e-sql
```
...
| --- | --- | --- | --- | --- |
| esql_generate | GenerateTask | generate_type=ESQLGenerator | execute_accuracy | `../files/datasets/spider_e_sql_esql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| esql_generate | stage | `../files/datasets/spider_e_sql_esql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/spider/e-sql.json
```
