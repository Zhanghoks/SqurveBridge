...
| Field | Value |
|---|---|
| Config | `reproduce/configs/bull-en/resdsql.json` |
| Dataset | `bull-en` |
| Method | `resdsql` |
| Run identifier | `bull-en-resdsql` |
...
```bash
python reproduce/run.py bull-en resdsql
```
...
| Name | Kind | Path |
| --- | --- | --- |
| resdsql_parse | stage | `../files/datasets/bull_en_resdsql_resdsql_parse.json` |
| resdsql_reduce | stage | `../files/datasets/bull_en_resdsql_resdsql_reduce.json` |
| resdsql_generate | stage | `../files/datasets/bull_en_resdsql_resdsql_generate.json` |
| resdsql_full | workflow | `../files/datasets/bull_en_resdsql_full.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/bull-en/resdsql.json
```
