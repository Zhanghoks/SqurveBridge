...
| Field | Value |
|---|---|
| Config | `reproduce/configs/bull-en/e-sql.json` |
| Dataset | `bull-en` |
| Method | `e-sql` |
| Run identifier | `bull-en-e-sql` |
...
```bash
python reproduce/run.py bull-en e-sql
```
...
| --- | --- | --- | --- | --- |
| esql_generate | GenerateTask | generate_type=ESQLGenerator | execute_accuracy | `../files/datasets/bull_en_e_sql_esql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| esql_generate | stage | `../files/datasets/bull_en_e_sql_esql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/bull-en/e-sql.json
```
