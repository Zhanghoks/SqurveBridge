...
| Field | Value |
|---|---|
| Config | `reproduce/configs/ambidb/dinsql.json` |
| Dataset | `ambidb` |
| Method | `dinsql` |
| Run identifier | `ambidb-dinsql` |
...
```bash
python reproduce/run.py ambidb dinsql
```
...
| --- | --- | --- | --- | --- |
| dinsql_generate | GenerateTask | generate_type=DINSQLGenerator | execute_accuracy | `../files/datasets/ambidb_dinsql_dinsql_generate.json` |

## Outputs

| Name | Kind | Path |
| --- | --- | --- |
| dinsql_generate | stage | `../files/datasets/ambidb_dinsql_dinsql_generate.json` |
...
```bash
python tools/verify.py reproduce-contract --path reproduce/configs/ambidb/dinsql.json
```
